  ...
  var Planner = function(){
    ...
    */
    ...
    this.runPlan = function (board, data, cb_nextExecution, cb_planCompleted){
      ...
      __runPlan(board, data, cb_nextExecution, cb_planCompleted);
    }


    var __runPlan = function(board, data, cb_nextExecution, cb_planCompleted){
      ...
      if(Object.keys(data).length == 0){
        ...
        cb_nextExecution(board, url, requestType, __runPlan);
      }
      else{
        ...
        ***************************************************************************/
        ...
        if(index_current_lemma < (plan.length)){
          ...
          console.log("Response Received by " + data["@id"] + " - Plan Completed!");
          ...
          if(i == num_current_data_stored)
            cb_planCompleted(buffer_resources_dependencies);
        }
