(function() {
  ...
  var Proxy = function(_dirname, use_case){
    ...
    this.setActuatorState = function(board, plantURL, newState, actuatorType, callback_return_algorithm){
      ...
      saveFile(default_path + "/preference.n3", str);
      ...
      str += "?actuator a vocab:" + actuatorType + ".\n";
      str += "}."
      saveFile(default_path + "/" + files_matching[current_use_case].setActuatorState, str);
        ...
        var req = http.request(options, function(resp){
          resp.on('data', function(chunk){
            ...
            *********/
            ...
            callback(data, executeRequest, managePlanResults, functionName, callback_return_algorithm);
          });
