        ...
        for(var i=0; i<lemma.length; i++){
          if(lemma[i].hasOwnProperty("data")){
            ...
            for(var h=0; h<data.length; h++){
              ...
              response[response.length-1][graph_name]["temperature"] = getValueOfTargetProperty("http://www.example.org/vocab#hasValue", "http://dbpedia.org/resource/Temperature", tmp_data);
              response[response.length-1][graph_name]["moisture"] = getValueOfTargetProperty("http://www.example.org/vocab#hasValue", "http://dbpedia.org/resource/Moisture", tmp_data);
              response[response.length-1][graph_name]["light"] = getValueOfTargetProperty("http://www.example.org/vocab#hasValue", "http://dbpedia.org/resource/Light", tmp_data);
            }
          }
        }
      }
